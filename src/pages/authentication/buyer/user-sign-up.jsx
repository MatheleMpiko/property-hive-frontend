...
//     if (isValid) {
//       console.log('Form submitted:', { name: form.name, email: form.email, password: form.password });
...
//             </p>
//           </div>
//           <h2 className="text-2xl font-bold text-gray-700 mb-6 mt-6">Create Account</h2>
...
//     setError('');
//     setIsTyping(false); // Stop typing when submission is valid
//     console.log(form);
//   };

//   const handleBlur = () => {
//     if (isPasswordValid()) {
//       setIsTyping(false); // Stop typing if password is valid when input loses focus
//     }
//   };
...
//                 value={form.password}
//                 onChange={handleChange}
//                 onBlur={handleBlur} // Check password validity on blur
//                 placeholder="Enter password"
//                 className="w-full border border-gray-300 p-3 rounded focus:outline-none focus:border-teal-500"
//               />
//               {/* Password Validation Feedback */}
...
//               disabled={!isPasswordValid() || passwordMatchError || nameError || emailError}
//             >
//               Sign Up
//             </button>
//           </form>
