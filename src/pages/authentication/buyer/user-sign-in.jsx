...
//   const [passwordError, setPasswordError] = useState('');
//   const [isSubmitted, setIsSubmitted] = useState(false);
//   const [serverError, setServerError] = useState(''); // To capture server-side errors
...
//           {serverError && <p className="text-red-500 text-sm mt-1">{serverError}</p>} {/* Display server error */}
...
//     if (isValid) {
//       try {
//         const response = await axios.post('/api/signin', { email, password }); // Adjust the URL as needed
//         console.log('Response:', response.data);
//         // Handle successful sign-in (e.g., redirect or store user info)
//       } catch (error) {
//         setServerError('Invalid credentials. Please try again.'); // Capture server error
//         console.error('Error signing in:', error);
//       }
//     }
//   };
...
//               <button
//                 type="submit"
//                 className="w-full p-3 bg-teal-600 text-white rounded-md shadow-sm hover:bg-teal-700 focus:ring-4 focus:ring-teal-500 focus:outline-none"
//               >
//                 Sign In
//               </button>
//             </div>
